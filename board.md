...
- [ ] 3. Implement MarketDataProvider for historical OHLCV data
- [ ] 4. For 1D time rance, use the 1-min intraday data. For longer ranges (5D, 1M, 3M, YTD, 1Y), use the historical OHLCV data
- [ ] 4. For historical data, buffer the data in DataBase
