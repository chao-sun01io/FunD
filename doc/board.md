...
- Use trading calendar to determine trading days and handle holidays/weekends, instead of relying on Redis freshness. As it might cause issues if query within the first few minutes of a trading day when the latest quote is not yet updated.
